...
router.post(
  "/usuario",
  [autenticacaoJwt.verificarToken, autenticacaoJwt.isAdmin],
...
router.post(
  "/consulta",
  [autenticacaoJwt.verificarToken, autenticacaoJwt.isAdminOrMedic],
  consultaController.create
);
router.get(
  "/consulta/:id",
  [autenticacaoJwt.verificarToken, autenticacaoJwt.isAdminOrMedicOrViewer],
...
router.get(
  "/primeiraconsulta",
  [autenticacaoJwt.verificarToken, autenticacaoJwt.isAdminOrMedic],
  consultaController.checkPrimeiraConsulta
); // Verifica se é a primeira consulta de um paciente
...
router.post(
  "/bloqueio/semana",
  [autenticacaoJwt.verificarToken, autenticacaoJwt.isAdmin],
  datasBloqueadasController.createSemana
);
router.get(
  "/bloqueio/semana",
  [autenticacaoJwt.verificarToken, autenticacaoJwt.isAdminOrMedicOrViewer],
  datasBloqueadasController.getAllSemana
);
router.put(
  "/bloqueio/semana/:id",
  [autenticacaoJwt.verificarToken, autenticacaoJwt.isAdmin],
  datasBloqueadasController.updateSemana
);
router.delete(
  "/bloqueio/semana",
  [autenticacaoJwt.verificarToken, autenticacaoJwt.isAdmin],
  datasBloqueadasController.deleteSemana
);
router.post(
  "/bloqueio/dia",
  [autenticacaoJwt.verificarToken, autenticacaoJwt.isAdmin],
  datasBloqueadasController.createDia
);
router.get(
  "/bloqueio/dia",
  [autenticacaoJwt.verificarToken, autenticacaoJwt.isAdminOrMedicOrViewer],
  datasBloqueadasController.getAllDia
);
router.put(
  "/bloqueio/dia/:id",
  [autenticacaoJwt.verificarToken, autenticacaoJwt.isAdmin],
  datasBloqueadasController.updateDia
);
router.delete(
  "/bloqueio/dia",
  [autenticacaoJwt.verificarToken, autenticacaoJwt.isAdmin],
  datasBloqueadasController.deleteDia
);
