                    ...
                    <v-form>
                        ...
                        <v-row class="mt-n5">
                            <v-col :md="12" :sm="12" :xl="12" cols="12">
                                <v-select v-model="paciente" hide-details="auto" :clearable="true" label="Paciente" item-text="label" item-value="value" outlined />
                            </v-col>
                        </v-row>
                        ...
                        <v-row class="mt-n3">
                            <v-col :md="12" :sm="12" :xl="12" cols="12">
                                <v-textarea v-model="descricao" hide-details="auto" outlined label="Descrição (Opcional)" auto-grow></v-textarea>
                            </v-col>
                        </v-row>
