...
.colDois {
  ...
  /*centralizar login no meio da página*/
  position: absolute;
  top: 50%;
  left: 50%;
  transform: translate(-50%, -40%);
  /*evitar com que a largura aumente muito*/
  max-width: 500px;
}
...
/*Responsivida dispositivo virado*/
